...
const CheckboxComp = ({
  ...
  return (
    <div class="inline-flex items-center" key={key}>
      ...
      <label
        class={`${className} flex items-center font-light text-gray-700 cursor-pointer select-none`}
        htmlFor={title}
      >
        <span className={`text-xs font-bold ${disabled && "text-[#c1c2c7]"}`}>
          {title}
        </span>
      </label>
    </div>
